...
####
    ...
    frame1_qv = ofc.drop_nan(frame1_qv)
   ...
   # frame1 = cv2.equalizeHist(frame1)
    ...
    for date in dates:
        ...
        frame2_qv = ofc.drop_nan(frame2_qv)
        ...
        flow = flowd
        prvs_qv = ofc.warp_flow(prvs_qv, flow)
...
#######
    ...
    vorticity_correction(start_date, var, pyr_scale, levels, iterations, poly_n, poly_sigma, sub_pixel, target_box_x, target_box_y, average_lon, tvl1, do_cross_correlation, farneback,
                        stride_n, dof_average_x, dof_average_y, cc_average_x, cc_average_y, winsizes, grid, Lambda, coarse_grid, pyramid_factor, dt, file_paths, file_paths_flow, dates, **kwargs)
