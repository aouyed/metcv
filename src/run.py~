...
def parser(process_parameters,parameters):
    ...
    parser.add_argument("-ed", "--end_date", help="The End Date - format YYYY-MM-DD-00:00", 
                        type=valid_date)
    parser.add_argument("-jl", "--jpl_loader", help="Whether we low jpl dataset", action ="store_true")
    parser.add_argument("-tk", "--track", help="Whether we load jpl amvs", action ="store_true")
