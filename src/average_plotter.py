...
df_cc_lo=pd.read_pickle('../data/processed/cc/df_mean_lon_speed_error.pkl')
df_cc_los=pd.read_pickle('../data/processed/cc/df_mean_lon_speed_approx.pkl')
df_cc_loss=pd.read_pickle('../data/processed/cc/df_mean_lon_speed.pkl')
...
####
fig, ax = plt.subplots()
ax=sns.lineplot(x=df_dof_st['lat'], y=df_dof_st['speed_std'], label='truth')
ax=sns.lineplot(x=df_dof_ss['lat'], y=df_dof_ss['speed_approx_std'], label='dof')
...
fig, ax = plt.subplots()
ax=sns.lineplot(x=df_cc_los['lon'], y=df_cc_los['speed_approx'], label='cc')
ax=sns.lineplot(x=df_cc_loss['lon'], y=df_cc_loss['speed'], label='truth')
